...
const AyurDashboard = () => {
  ...
  const pdfRef = useRef(null); // Ref for the hidden PDF content
        ...
        <div className="ad-feature-cards">
          ...
          <div className="ad-feature-card" onClick={triggerHerbRain}>
            ...
            <div className="ad-feature-card-content">
              ...
              <button className="ad-feature-button">Explore Plans</button>
            </div>
          </div>
          ...
          <div className="ad-feature-card" onClick={triggerHerbRain}>
            ...
            <div className="ad-feature-card-content">
              ...
              <button className="ad-feature-button">Browse Remedies</button>
            </div>
          </div>
        </div>
      </div>
