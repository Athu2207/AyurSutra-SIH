...
const AyurSutra = () => {
  ...
  const yogaFigureRef = useRef(null);
  const herbsContainerRef = useRef(null);
      ...
      <header ref={headerRef} className="ayur-header">
        ...
        <div className="ayur-container">
          <nav className="ayur-nav-container">
            <div ref={logoRef} className="ayur-logo">
        ...
        <div ref={heroContentRef} className="ayur-hero-content">
          ...
          <a className="ayur-cta-button" onClick={(e)=>nav("/ayursutra-home")}>Get Started</a>
        </div>
